...
const updateTaskFormSchema = createTaskSchema.omit({
  workspaceId: true,
  description: true,
})
...
export const EditTaskForm = ({
  ...
  const editTaskForm = useForm<z.infer<typeof updateTaskFormSchema>>({
  ...
  const onSubmit = (values: z.infer<typeof updateTaskFormSchema>) => {
    const finalValues = {
      ...values,
